...
renderPage(products);
  // никак не пойму, что имеется ввиду во втором задании под "добавить значения по умолчанию для аргументов функции"
  // неужто имеют ввиду значения по умолчанию для названия и цены продукта?
  // сдаю в таком виде, не разобравшись с тем, что имелось ввиду во втором задании.